...
export interface Evidence { id: string; claim: string; source: string; runner: string; command?: string; exitCode?: number; artifact?: string; digest: string; timestamp: string; scope: { commit?: string; [key: string]: unknown }; }
